...
trait HasNestedResource
{
    ...
    {
        return new NestedBasicAddAction(__('Add') . ' ' . $this::singularLabel());
    }
    ...
    {
        return tap(new NestedBasicDeleteAction(__('Remove') . ' ' . $this::singularLabel()), function (NestedBasicDeleteAction $action) {
    ...
    {
        return new NestedBasicRestoreAction(__('Restore') . ' ' . $this::singularLabel());
    }
