<template>
    <LoadingView :class="['nested-many-form', fieldClass]" :loading="initialLoading" v-show="isVisible">
        <div>
            <Heading
                :level="1"
            ...
            >
                <div class="flex flex-wrap items-center">
                    <Button
                        ...
                        :disabled="loading"
                        variant="action"
                        :icon="!isPanelView ? 'view-columns' : 'table-cells'"
...
<script>
    ...
    export default {
        ...
        components: { FormPanelsNestedResource, FormTabsNestedResource, ActionSelector, Button },
        ...
        computed: {
            ...
            fieldClass() {
                return this.field?.extraAttributes?.class ?? '';
            },
